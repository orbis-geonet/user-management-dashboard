...
const SeePieChartButton = ({record, source}) => {
    ...
    return (
        <Fragment>
            <Button className={classes.button} label="See pie chart" onClick={onClick}/>
            <Dialog
                fullWidth
                open={showGraph}
...
export default SeePieChartButton;
